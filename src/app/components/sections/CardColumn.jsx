...
const CardColumn = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const doc = await client.getByUID("cardcolmunfirst", String(9));
        console.log(doc)
  ...
  return (
    <section className='CardColumn w-full relative py-[45px] lg:py-[100px] overflow-hidden max-w-[1920px] bg-white mx-auto min-h-[632px] flex flex-col justify-center'>
